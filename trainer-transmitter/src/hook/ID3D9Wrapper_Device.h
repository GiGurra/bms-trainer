...
public:
	...
	IDirect3DDevice9* m_backingDevice;
	IDirect3D9* m_backingD3dIfc;
	UINT m_Stride;

private:
	int m_comRefCount;

	DxSurfaceCopyer m_sensorsCopyer;
	DxSurfaceCopyer m_backbufferCopyer;
	IDirect3DSurface9 * m_sensorsSrc;

	DxTcpMirror m_tcpMirror;
